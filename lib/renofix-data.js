export const SERVICES = [
  ...
  },
  {
    ...
    faqs: [
      { q: "How much does a bathroom renovation cost in Dubai?", a: "Most bathroom renovations range from AED 12,000 to AED 28,000 depending on size, finishes and the amount of plumbing rework required." },
      { q: "Do you guarantee the waterproofing?", a: "Yes. Waterproofing is the most critical step. We use proven systems and back our workmanship with a warranty." },
    ],
  },
  {
...
export const AREAS = [
  { slug: "dubai-marina", name: "Dubai Marina", type: "apartment" },
  { slug: "jvc", name: "Jumeirah Village Circle", type: "apartment" },
  { slug: "business-bay", name: "Business Bay", type: "apartment" },
  { slug: "downtown-dubai", name: "Downtown Dubai", type: "apartment" },
  { slug: "arabian-ranches", name: "Arabian Ranches", type: "villa" },
  { slug: "jumeirah", name: "Jumeirah", type: "villa" },
  { slug: "palm-jumeirah", name: "Palm Jumeirah", type: "villa" },
  { slug: "dubai-hills-estate", name: "Dubai Hills Estate", type: "villa" },
];
